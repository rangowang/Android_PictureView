...
public class PictureAdapter extends BaseAdapter {
    ...
    public PictureAdapter(Context context, List<String> list, GridView mGridView) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        mSelectImagePath = path;
        if(convertView == null){
            convertView = mInflater.inflate(R.layout.content_picture_list, null);
